...
class Cohort:
    ...
    def get_pct_survive_5y(self):
        return self._num_of_surviving_5_y/len(self._survivalTimes)
...
class MultiCohort:
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store percentage of surviving over 5 years for this cohort
            self._pct_survive_5y.append(cohort.get_pct_survive_5y())
        ...
        self._sumStat_pct_survive_5y = Stat.SummaryStat('Percentage of surviving over 5 years of each cohort', self._pct_survive_5y)

    def get_cohort_pct(self, cohort_index):
        return self._pct_survive_5y[cohort_index]

    def get_cohort_pct_list(self):
        return self._pct_survive_5y
